 ...
 const chan = ()=>{
    ...
    return (
      ...
      <div className='col-md-4 form' id='sub' style={props.mode==='light'?{color:'black',backgroundColor:'white',border: '3px solid black'}:{color:'white',backgroundColor:'black',border: '3px solid white'}}><h2 className='text-center'>LogIn/SignUp</h2>
        ...
        <div className='mt-4'id='icns'>
           ...
           <a href="https://www.facebook.com/login/"><i className="fa fa-2x fa-facebook-official"></i></a>
            <a href="https://accounts.google.com/signinchooser?ifkv=AeAAQh4hG3swBqX66zBXdZFV7Tx3jIDecvn7cfCvAX7BEx9GWZ7APYugk9ox0J6bIZgfI_mqIQgX&flowName=GlifWebSignIn&flowEntry=ServiceLogin"><i className="fa fa-x fa-google-plus"></i></a>
      ...
      <form className=' px-2 py-3'>
              ...
              <div className="mb-3">
                <label className="form-label" id="a4">Password</label>
                <input type="password" className="form-control" id="Password1"/>
              </div>
              <div className="mb-3">
                <label className="form-label" id="a5">Confirm Password</label>
